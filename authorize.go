...
func main() {
	...
	am := &resource.AuthMessage{
		Id:             id,
		IdentityImages: []string{"222,333,11111111111111111", "abckieidkilf", "111,222,333332"},
		DomainImages:   []string{"111 11 333333333444444", "dikfkdikaaaa"},
		CompanyUscc:    "11111111111111111",
		CompanyImages:  []string{"11111111111111111", "333333333333"},
		Status:         0,
		Zone:           "zhanglei.test.",
	}
